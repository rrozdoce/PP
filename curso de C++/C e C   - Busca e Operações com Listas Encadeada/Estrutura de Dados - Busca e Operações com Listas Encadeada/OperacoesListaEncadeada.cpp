...
void removeInicioEncadeada(pessoa *&ponteiroEncadeada, string *nome, int *rg){
    ...
    *rg = ponteiroEncadeada->rg;
    ...
    //O ponteiroEncadeada recebe o endereço do proximo elemento,Agora o segundo elemento torna-se o ponteiroEncadeada
...
void removePosicaoEncadeada(pessoa *ponteiroEncadeada,string *nome,int *rg, int posicao){
    ...
    while(i <= posicao){
        ...
        //Caso tenha alcanÁado a posicao desejada
        if(i == posicao-1){
